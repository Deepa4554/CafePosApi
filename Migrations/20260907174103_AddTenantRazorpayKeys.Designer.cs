...
namespace CafePOS.Api.Migrations
{
    ...
    [Migration("20260907174103_AddTenantRazorpayKeys")]
    partial class AddTenantRazorpayKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.CafeExpense", b =>
                {
                    ...
                    b.Property<int?>("PurchaseListItemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.CafeSettings", b =>
                {
                    ...
                    b.Property<bool>("ApprovalAlertsEnabled")
                        .HasColumnType("boolean");

                    b.Property<string>("BorzoAuthToken")
                        .HasColumnType("text");

                    b.Property<string>("BorzoCallbackToken")
                        .HasColumnType("text");

                    b.Property<bool>("BorzoCollectCodOnDelivery")
                        .HasColumnType("boolean");

                    b.Property<bool>("BorzoEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("BorzoPassFeeToCustomer")
                        .HasColumnType("boolean");

                    b.Property<bool>("BorzoUseTestEnvironment")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("DynoAutoAccept")
                        .HasColumnType("boolean");

                    b.Property<string>("DynoBridgeToken")
                        .HasColumnType("text");

                    b.Property<int>("DynoDefaultPrepTimeMins")
                        .HasColumnType("integer");

                    b.Property<bool>("DynoEnabled")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("DynoLastContactAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("EveningShiftEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("GeneralShiftEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("MenuPricesIncludeTax")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("TaxByPaymentModeEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("TaxChargesEnabled")
                        .HasColumnType("boolean");

                    b.Property<decimal>("TaxRatePct")
                        .HasColumnType("numeric");

                    b.Property<string>("TaxablePaymentModes")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("WhatsAppOrderUpdatesEnabled")
                        .HasColumnType("boolean");

                    b.Property<string>("ZomatoRestaurantId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.GuestCall", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.Offer", b =>
                {
                    ...
                    b.Property<int>("MaxApplicationsPerBill")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.Order", b =>
                {
                    ...
                    b.Property<string>("AppliedOfferTitle")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal>("ChargesTaxAmount")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("ChargesTaxRatePct")
                        .HasColumnType("numeric");

                    b.Property<decimal>("ChargesTaxableAmount")
                        .HasColumnType("numeric");
                    ...
                    b.Property<DateTime?>("CourierBookedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal?>("CourierFeeAmount")
                        .HasColumnType("numeric");
                    ...
                    b.Property<string>("CourierRiderName")
                        .HasColumnType("text");

                    b.Property<string>("CourierRiderPhone")
                        .HasColumnType("text");

                    b.Property<string>("CourierStatus")
                        .HasColumnType("text");

                    b.Property<string>("CourierTrackingUrl")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal?>("PlatformGrossAmount")
                        .HasColumnType("numeric");
                    ...
                    b.HasIndex("TenantId", "TableCode");

                    b.HasIndex("TenantId", "BranchId", "CreatedAt");

                    b.HasIndex("TenantId", "Paid", "Status");

                    b.HasIndex("TenantId", "PlatformProvider", "PlatformOrderId")
                        .IsUnique()
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.OrderItem", b =>
                {
                    ...
                    b.Property<bool>("VoidedUnprepared")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.PlatformCatalogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("PlatformEntityId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("TenantId", "Provider", "ResId", "PlatformEntityId", "IsCategory")
                        .IsUnique();

                    b.ToTable("PlatformCatalogEntries");
                });
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.PlatformMenuMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PlatformMenuMappings");
                });

            modelBuilder.Entity("CafePOS.Api.Domain.PlatformOrderPayload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PlatformOrderPayloads");
                });

            modelBuilder.Entity("CafePOS.Api.Domain.PlatformStockChange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("DesiredInStock")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("TenantId", "ResId", "ProcessedAt");

                    b.ToTable("PlatformStockChanges");
                });
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.Tenant", b =>
                {
                    ...
                    b.Property<string>("EnabledScreens")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.WaitlistEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.WhatsAppMessageLog", b =>
                {
                    ...
                    b.Property<string>("ToOrFromPhoneE164")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.WhatsAppOrderTracking", b =>
                {
                    ...
                    b.Property<string>("WhatsAppNumberE164")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.WhatsAppSession", b =>
                {
                    ...
                    b.Property<string>("LastDisconnectReason")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CafePOS.Api.Domain.OfferMenuItem", b =>
                {
                    b.HasOne("CafePOS.Api.Domain.Offer", null)
                        .WithMany("Items")
